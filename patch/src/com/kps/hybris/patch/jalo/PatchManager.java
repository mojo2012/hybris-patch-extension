 ...
 */
package com.kps.hybris.patch.jalo;
...
import com.kps.hybris.patch.constants.PatchConstants;
import com.kps.hybris.patch.service.PatchService;



/**
 * This is the extension manager of the Patch extension.
 */
public class PatchManager extends GeneratedPatchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PatchManager.class);
	...
	{
		return (PatchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PatchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PatchManager() // NOPMD
	{
		LOG.debug("constructor of PatchManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PatchManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PatchManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	protected PatchService getPatchService()
	{
		return Registry.getApplicationContext().getBean(PatchService.class);
	}
}
